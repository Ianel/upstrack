...
const Hero = () => {
  return (
    <section className="px-14 bg-[#F0EFE9] h-full flex flex-row items-center">
      <div className="w-1/2 pr-4">
        <p>- More than 1000 User Active every day</p>
        <h2 className="text-5xl font-bold pt-8 leading-[4rem]">
        ...
        <p className="py-8 text-tertiary">
          ...
          tenetur ex numquam, autem expedita quae tempore, modi hic quasi
          adipisci qui laudantium dolor explicabo aliquid dicta mollitia
          delectus asperiores!
        </p>
      ...
      <div className="w-1/2 pl-4 relative">
        <div className="absolute -top-60">
          ...
          <section className="bg-white rounded-sm p-4 w-64 2xl:w-72 my-4">
            ...
            <div className="flex flex-row items-center gap-x-2">
              <span className="text-xs text-tertiary mt-2">Engagement</span>
            ...
            <div className="flex flex-row items-center gap-x-2">
              <span className="text-xs text-tertiary mt-2">Impression</span>
        ...
        <img
          src={profilePicture}
          className="object-cover absolute 2xl:w-4/5 right-0 -top-40"
          alt="Woman Photo"
        />
        <div className="absolute top-40 2xl:top-72 right-0 bg-secondary text-white w-64 p-4 flex flex-row justify-between items-center">
          <div>
            <p className="text-sm font-bold">Our Digital</p>
            <p className="text-xs">Marketing Expertise</p>
          </div>
          <img className="object-cover w-5" src={smiley} alt="Smiley" />
        </div>
      </div>
    </section>
  );
