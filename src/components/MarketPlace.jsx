...
const MarketPlace = () => {
    ...
    return (
        <div className="lg:mt-32 mt-16 lg:pt-12 px-12" id="marketplace">
            <h2 className="text-center text-primary text-sm font-bold">
                OUR MARKETPLACE
            </h2>
            <h3 className="text-center text-2xl font-bold">Ready to collect</h3>
            <div className="my-8 flex flex-row flex-wrap gap-4 justify-between items-center">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 2xl:gap-12">
